...
File Descriptions
[Here](https://github.com/ebelingbarros/Trees_in_Berlin/blob/main/1st%20project%20-%20Udacity.ipynb) is the link to the Jupyter Notebook, where I created some preliminary visualisations. The notebook is exploratory in searching through the data pertaining to the questions showcased by the notebook title. Markdown cells were used to assist in walking through the thought process for individual steps. However, the visualisations I included in the story were created in Tableau, and are available by [accessing my Tableau page](https://public.tableau.com/profile/francisco.ebeling#!/). 
